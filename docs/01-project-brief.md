...
Every coding tool in 2026 answers the same question: *"How do I build it?"*

None of them answer: *"What should I build? How should it work? How do it scale?"*

The current market is split into two camps:

**Vibe builders** (Lovable, Bolt, Replit, v0)
→ Fast. Shallow. Breaks past MVP.

**Engineering agents** (Cursor, Claude Code, Windsurf)
→ Powerful. Requires real technical skill. No product thinking.

**The gap no one fills:**
- No real product system thinking
- Weak UX and design intelligence
- No structured workflow from idea → scale
- No deep design system generation
- No memory of product evolution over time
- No founder-level guidance — only code
...
### Primary — The Product-Led Founder
...
| Design Systems Generated | 25,000 |
| Weekly Retention | >60% |
| NPS Score | >50 |
| Time-to-first-product (onboarding) | <15 minutes |

---

## Competitive Moat

1. **Memory layer** — persistent product intelligence no competitor has
2. **Design system depth** — real token architecture, not just color palettes
3. **Upstream positioning** — not competing with Cursor or Lovable, feeds them
4. **Handoff-first output** — everything is usable by someone else without explanation
5. **Founder intelligence** — strategic guidance layer on top of execution
...
- Direct Figma plugin integration (v2)
- Code generation (never — we feed coding tools, we don't compete with them)
- Mobile app (v2)
- White-labeling / agency tier (v3)

---

## Team This Brief Is For

- **Design team** → Read Project Brief + Designer Guidelines + Design System + UX Microcopy + Pages & Flows
- **Dev team** → Read Project Brief + PRD + Dev Docs
- **Both** → Read the full pack
